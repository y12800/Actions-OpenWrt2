...
git clone --depth 1 https://github.com/coolsnowwolf/lede/tree/master/package/lean deng-tmp5 && mv deng-tmp5/net/ddns-scripts_aliyun package/deng/ddns-scripts_aliyun && mv deng-tmp5/net/ddns-scripts_dnspod package/deng/ddns-scripts_dnspod
